 ...
 */
public abstract class ProtocolsBaseSyncRequest<T> {
	...
	public ProtocolsBaseSyncRequest(@NonNull String baseUrl) {
		mBaseUrl = baseUrl;
	}
	 ...
	 * @return Observable
	 */
	public abstract Call<T> getCall(Retrofit retrofit);
